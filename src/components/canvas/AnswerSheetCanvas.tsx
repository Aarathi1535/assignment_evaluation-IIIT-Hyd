...
export function AnswerSheetCanvas({
  ...
  const handleResetZoom = useCallback(() => {
    ...
    onFitPage?.();
  }, [baseBounds, onTransformChange, onFitPage]);
  ...
  const handleFitWidth = useCallback(() => {
    ...
    onTransformChange?.(nextTransform);
    onFitWidth?.();
  }, [baseBounds, rotation, minZoom, maxZoom, onTransformChange, onFitWidth]);
  ...
  const handleActualSize = useCallback(() => {
    ...
    setTransform({ x: nextTransform.x, y: nextTransform.y, zoom: nextTransform.zoom });
    onTransformChange?.({ x: nextTransform.x, y: nextTransform.y, zoom: nextTransform.zoom });
    onActualSize?.();
  }, [baseBounds, minZoom, maxZoom, onTransformChange, onActualSize]);
