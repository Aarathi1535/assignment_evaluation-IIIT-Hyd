      ...
      try {
        ...
        if (examData.success && examData.data) {
          ...
          if (exam.examDate) {
            ...
            // Compensate for local timezone offset to get the correct ISO representation
          ...
          reset({
            ...
            totalMarks: exam.totalMarks !== undefined ? String(exam.totalMarks) : '',
            numberOfQuestions: exam.numberOfQuestions !== undefined ? String(exam.numberOfQuestions) : '',
        ...
        setErrorMsg('An error occurred while loading details. Please refresh the page.');
      } finally {
