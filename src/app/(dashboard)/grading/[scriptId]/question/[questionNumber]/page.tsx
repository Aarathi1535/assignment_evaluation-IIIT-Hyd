...
export default function QuestionGradingPagePlaceholder() {
  ...
  return (
    <DashboardLayout
      ...
      description="Evaluate and grade specific questions on exam submissions."
    >
      <div className="bg-white border border-slate-200 rounded-brand-lg p-6 max-w-2xl mx-auto space-y-6 shadow-sm">
        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
          <div className="h-10 w-10 rounded-full bg-purple-50 text-purple-650 flex items-center justify-center font-bold">
            <BookOpen className="h-5 w-5" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-slate-900">Grading Portal Placeholder</h2>
            <p className="text-xs text-slate-500">Evaluating Question-wise Allocation</p>
          </div>
        </div>
        ...
        <div className="space-y-3 bg-slate-50 p-4 rounded-brand border border-slate-200/60 text-sm">
          ...
          <p className="flex justify-between">
            ...
            <span className="font-bold text-slate-900">Question {questionNumber}</span>
          </p>
        </div>
